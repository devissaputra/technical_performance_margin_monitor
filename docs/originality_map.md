...
- `lstm_time_series`
- `anomaly_detection`
- `engagement_early_warning`

## Why this empirical bundle is distinct
The dependent quantity is a formal engineering performance margin to a known EOL threshold on run-to-failure hardware data. The analysis is a transparent prognostics baseline, not a generic forecasting leaderboard, anomaly detector, or learner-risk system.
